...
<body>
	...
	<div id="smart-button-container" class="a row" style="padding-top:50px;">
		...
		<div class="row" style="text-align: center; height: 800px;">
			...
			<div class='col-xl-12 row' style="height: 60px;">
				<div class='row'>
					...
					<button class="btn btn-primary col-xl-2" id="btnFecha" style="height: 40px; margin-top: 30px;">Reiniciar</button>
				</div>
